	...
	public static void lectura(Obligatorio obligatorio) {
		...
		try {
			...
			while (scanner.hasNext()) {
				...
				String nroHab = line.getElementFrom(4);
				...
				obligatorio.crearProductoSoloStrings(nombreProducto, nombreDeFantasia, status, idProduct, clase, pais,
						marca, empresa, ruc, rubro, nroHab);
			}
			scanner.close();
