...
public class Obligatorio {
	...
	public void reporte10MarcasConMasProductosHabilitados() {
		...
		for (int j = 1; j < 11; j++) {
			System.out.println("-Marca: " + reporte2[(reporte2.length) - j].getName() + " -Cantidad de productos: "
					+ reporte2[(reporte2.length) - j].getProductoDeLaMarca().size() + " -Pa�s de origen: "
	...
	public boolean elegirReporte() {
		...
		do {
			...
			System.out.println("2- Listar las 10 marcas por pa�s que tienen mayor cantidad de productos habilitados.");
			System.out.println("3- Listar los 10 pa�ses que disponen la mayor cantidad de productos habilitados.");
			System.out.println("4- Listar las 20 clases por pa�s que tienen mayor cantidad de productos habilitados.");
		...
		case "1":
			...
			endTime = System.nanoTime(); // Medici�n de tiempo en cada caso para evitar error
